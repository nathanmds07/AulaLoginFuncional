...
public class TelaLogin extends javax.swing.JFrame {
    ...
    public TelaLogin() {
        ...
        if (conexao != null) {
            ImageIcon iconeVerde = new ImageIcon("src/img/database_fail_Icon.png");
            lblIcon.setIcon(iconeVerde);
        } else {
            ImageIcon iconeAzul = new ImageIcon("src/img/databasea_Icon.png");
            lblIcon.setIcon(iconeAzul);
